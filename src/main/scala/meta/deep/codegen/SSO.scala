...
import meta.deep.member.{Method, CompiledActorGraph}
...
//         val methodToCopyGraph: ListBuffer[EdgeInfo] = utilObj.getEdgesByMtdId(neededElement.graph, methodId)
...
//     def setPosRef(callMethodEdges: ListBuffer[EdgeInfo]): Unit = {
...
//       */
//     @scala.annotation.tailrec
//     def setMtdRef(callMethodEdges: ListBuffer[AlgoInfo.EdgeInfo]): Unit = {
//       val (currentMethodEdges, restMethodEdges) = callMethodEdges.splitAt(3)
