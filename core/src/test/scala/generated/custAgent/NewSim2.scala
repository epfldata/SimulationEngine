...
class NewSim2 (val n: generated.meta.test.custAgent.NewSim2) extends meta.runtime.Actor with meta.test.custAgent.custActor {
  ...
  data_15.update(8, (() => {
    ...
    val x_47 = scala.`package`.Right.apply[scala.Nothing, scala.Int](6);
    val x_48 = x_46.==(x_47);
    if (x_48)
      positionVar_14 = 9
    else
  ...
  data_15.update(15, (() => {
    ...
    val x_56 = scala.`package`.Right.apply[scala.Nothing, scala.Int](6);
    val x_57 = x_55.==(x_56);
    ...
    if (x_84)
      {
        ...
        val x_87 = x_86.id;
        val x_88 = scala.`package`.Right.apply[scala.Nothing, scala.Int](6);
