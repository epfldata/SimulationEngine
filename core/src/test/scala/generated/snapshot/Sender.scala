...
private 
  ...
  data_8.update(1, (() => {
    ...
    val x_12 = scala.collection.immutable.Nil.::[scala.collection.immutable.List[scala.Any]](((scala.collection.immutable.Nil): scala.collection.immutable.List[scala.Any]));
    val x_13 = meta.runtime.RequestMessage.apply(x_10, x_11, false, "rpc1", x_12);
    val x_14 = x_13.sessionId;
    val x_15 = meta.runtime.Future.apply$default$2[scala.Int];
    val x_16 = meta.runtime.Future.apply[scala.Int](x_14, x_15);
    var v_17: meta.runtime.Future[scala.Int] = x_16;
    ((this): meta.runtime.Actor).sendMessage(x_13);
    val x_18 = x_13.sessionId;
    ((this): meta.runtime.Actor).setMessageResponseHandler(x_18, ((response_19: meta.runtime.Message) => {
      val x_20 = v_17;
      val x_21 = response_19.asInstanceOf[meta.runtime.ResponseMessage];
      val x_22 = x_21.arg;
  ...
  override def run(msgs: List[meta.runtime.Message]): (List[meta.runtime.Message], Int) = {
    ...
    override def gotoHandleMessages(new_ir: Int = 3): meta.runtime.Actor = {
      ...
      if (positionVar_7 > 6) {
        positionVar_7 = reflectionIR_73
        reflectionIR_73 = -1
      }
      this
    }
    
override def SimClone(): Sender = {
  val newAgent = new Sender(r)
