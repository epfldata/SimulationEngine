...
class Bus() extends generated.meta.test.inheritance3.ShortDistanceTransport {

   var currentPassengers: Int = 30;
  price = 20;
  load = 10;
  override val licensePlate: Int = 0;
  override val licensePlace: Int = 800;
...
private 
  ...
  data_15.update(11, (() => {
    val x_42 = this.currentPassengers;
    resetData_0 = x_42;
  ...
  override def handleNonblockingMessage(m: meta.runtime.RequestMessage): Unit = {
    ...
    override def gotoHandleMessages(new_ir: Int = 2): meta.runtime.Actor = {
      ...
      if (reflectionIR_62 == -1){
        reflectionIR_62 = positionVar_14
      ...
      if (positionVar_14 > 20) {
        positionVar_14 = reflectionIR_62
        reflectionIR_62 = -1
      }
      this
    }
    
override def SimClone(): Bus = {
  val newAgent = new Bus()
  newAgent.currentPassengers = currentPassengers
...
override def SimReset(): Unit = {
  positionVar_14 = 0
  val newAgent = new Bus()
  currentPassengers = newAgent.currentPassengers
