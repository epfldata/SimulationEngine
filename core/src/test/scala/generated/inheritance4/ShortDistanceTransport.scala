...
class ShortDistanceTransport() extends generated.meta.test.inheritance4.Vehicle {
  ...
  private var  reflectionIR_59: Int = -1
...
private 
  ...
  override def handleNonblockingMessage(m: meta.runtime.RequestMessage): Unit = {
    ...
    override def gotoHandleMessages(new_ir: Int = 3): meta.runtime.Actor = {
      ...
      if (reflectionIR_59 == -1){
        reflectionIR_59 = positionVar_13
      ...
      if (positionVar_13 > 22) {
        positionVar_13 = reflectionIR_59
        reflectionIR_59 = -1
      }
      this
    }
