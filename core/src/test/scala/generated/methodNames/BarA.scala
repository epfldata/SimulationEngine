...
class BarA() extends generated.meta.test.methodNames.FooA {
...
private 
  ...
  override def handleNonblockingMessage(m: meta.runtime.RequestMessage): Unit = {
    ...
    override def gotoHandleMessages(new_ir: Int = 3): meta.runtime.Actor = {
      ...
      if (positionVar_8 > 27) {
        positionVar_8 = reflectionIR_25
        reflectionIR_25 = -1
      }
      this
    }
    
override def SimClone(): BarA = {
  val newAgent = new BarA()
