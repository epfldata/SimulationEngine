...
object InitData  {
  ...
  x_2.foreach[scala.Unit](((i_3: scala.Int) => {
    val backendServer_4 = new generated.meta.example.server_communication_merged.BackendServer();
    val frontendServer_5 = new generated.meta.example.server_communication_merged.FrontendServer();
