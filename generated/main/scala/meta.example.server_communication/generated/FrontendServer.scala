...
class FrontendServer () extends meta.deep.runtime.Actor with Serializable {
  var backendServer: generated.meta.example.server_communication.BackendServer = null
  ...
  private var bindingMut_6: generated.meta.example.server_communication.BackendServer = null;
  ...
  data_15.update(3, (() => {
    ...
    val x_24 = x_23.asInstanceOf[generated.meta.example.server_communication.BackendServer];
    bindingMut_6 = x_24;
    val x_25 = ((this): meta.deep.runtime.Actor).id;
    val x_27 = {
      val x_26 = bindingMut_6;
      x_26.asInstanceOf[generated.meta.example.server_communication.BackendServer]
    };
    val x_28 = x_27.id;
